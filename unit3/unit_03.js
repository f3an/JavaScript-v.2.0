...
function f3(input1, input2, out) {
  input1 = +document.querySelector(".i-31").value;
  input2 = +document.querySelector(".i-32").value;
...
function f5(input, out) {
  input = +document.querySelector(".i-5").value;
...
function f7(input1, input2, out, res) {
...
function f8(input, out) {
  input = document.querySelector(".s-8").value;
...
function f9(input, out) {
  input = +document.querySelector(".i-9").value;
...
function f10(input, out) {
  input = document.querySelector(".s-100").value;
...
function f11(input, out) {
  input = document.querySelector(".s-110").value;
...
function f13(input, out) {
  input = document.querySelector(".i-130").value;
  out = document.querySelector(".out-13");
  out.textContent = typeof input; // <-- все время возвращает строку потому что в переменную передается значение инпута а оно всегда стринговое, чтоб передалось число надо поставить + перед (document.querySelector(".i-130").value);
}
...
function f14(num1, num2, res, operation, out) {
  num1 = +document.querySelector(".i-141").value;
  num2 = +document.querySelector(".i-142").value;
  operation = document.querySelector(".s-143").value;
