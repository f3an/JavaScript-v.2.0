...
let GOODS_VAR2 = new Goods("Iphone", 2, img1, 5, out4);
GOODS_VAR2.draw("1000$");
//Task 5.
...
img2.src = "/img/2.png";
let GOODS_VAR3 = new Goods2("Iphone", 2, img2, 5, out6, false);
GOODS_VAR3.draw("1000$");
// Task 7.
...
let VALID_VAR = new Valid("asdasdasda", "sss5a");

VALID_VAR.validate();
console.log(VALID_VAR);
...
VALID_VAR = new Valid("asdasdasda", "64564564");
VALID_VAR.validate();
console.log(VALID_VAR);
//Task 10.
...
let VALID_VAR2 = new Valid2("", "aaaaaaaa");
VALID_VAR2.validate();
//Task 12.
...
let VALID_VAR3 = new Valid2("aaaaaaaa", "aaaaaaaa");
VALID_VAR3.validate();