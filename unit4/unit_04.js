...
function f4(input, out) {
  input = document.querySelector(".i-4");
...
function f5(input, out) {
  input = document.querySelector(".i-5");
...
function f6(input, out) {
  ...
  out = document.querySelector("div.out-6");
  out.textContent = input.value;
}
...
function f7(input, out1, out2, splits) {
  input = document.querySelector(".i-7").value;
  out1 = document.querySelector("div.out-71");
  out2 = document.querySelector("div.out-72");
...
function f8(out, btn) {
  out = document.querySelector("div.out-8");
  out.innerHTML = `
    <input type="text" class="i-81"> <br>
    <button class="button-primary b-81">New Btn</button>
    `;
  btn = document.querySelector(".b-81");
  btn.addEventListener("click", f81, false);
}

function f81(input, out) {
  input = document.querySelector(".i-81").value;
  out = document.querySelector(".out-81");
...
function f9(input, out) {
  input = document.querySelector(".r-9");
...
function f10(input, out) {
  input = document.querySelector(".i-10");
  out = document.querySelector("div.out-10");
...
function f11(input1, input2) {
  input1 = document.querySelector(".i-111");
...
function f12(input, out) {
  input = document.querySelector(".i-12");
...
function f13(input, out) {
  input = document.querySelector(".i-13");
...
function f14(input, out) {
  input = document.querySelector(".t-14");
...
function f15(input, textarea, out) {
  input = document.querySelector(".i-15");
...
function f16(select, out) {
  select = document.querySelector(".s-16");
...
function f17(select, out) {
  select = document.querySelector(".s-17");
...
function f18(select, input) {
  select = document.querySelector(".s-18");
...
function f19(pass, input, out) {
  input = document.querySelector(".i-191");
  pass = document.querySelector(".i-192");
  out = document.querySelector(".out-19");
  out.textContent = `${input.value} ${pass.value}`;
}
...
function f20(e, out) {
  ...
  out.textContent = `${form.elements.username.value} ${form.elements.password.value}`;
}
