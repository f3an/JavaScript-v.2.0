...
function f6(temp) {
  temp = document.querySelector(".i-6").value;
  d6[d6.length] = temp;
  showArr(".out-6", d6);
  console.log(d6);
}
...
function f8(temp) {
  temp = document.querySelector(".i-8");
  d8 = [temp.value, ...d8];
  console.log(d8);
  showArr(".out-8", d8);
}
...
function f11(temp, out) {
  temp = document.querySelector(".i-11");
  out = document.querySelector(".out-11");
  out.textContent = d11.indexOf(parseInt(temp.value));
}
...
function f12(temp, out) {
  temp = document.querySelector(".i-12");
  out = document.querySelector(".out-12");
  for (let i = 0; i < d12.length; i++) {
    if (d12[i] === parseFloat(temp.value)) {
...
function f14(temp) {
    temp = document.querySelector(".i-14");
    for (let i = 0; i < parseInt(temp.value); i++) {
        d14.push(1);
    }
  showArr(".out-14", d14);
  d14 = [];
...
function f15(temp) {
    temp = document.querySelector(".i-15");
    if (d15.indexOf(parseInt(temp.value))) {
     d15.push(parseInt(temp.value));
    }
  showArr(".out-15", d15);
}
...
function f18(temp) {
    temp = document.querySelector(".i-18");
    out = document.querySelector(".out-18");
    if (!d18.includes(temp.value)) {
        d18.push(temp.value);
    }
    out.textContent = d18
}
...
function f19(temp,out) {
    temp = "";
    out = document.querySelector(".out-19");
    for (let i = 0; i < d19.length; i++) {
        if (d19[i].length>temp.length) {
            temp = d19[i];
        } 
    }
    maxString = temp;
