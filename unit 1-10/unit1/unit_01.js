...
const birthday = new Date ("02 06 2000");
console.log(`просто напишите номер месяца здесь ${birthday.getMonth()+1}`);
...
document.querySelector('.container>section>h2>span').innerHTML = "world"
...
document.querySelector(".four").innerHTML = '<h4>Hello World</h4>' + '<p>lorem lorem</p>'
...
const y2 = 3;
const res2 = y1 / y2;
const output2 = document.querySelector(".out-15");

output2.innerHTML =` ${y1} / ${y2} = ` + res2;
...
const x1 = 'Hello';
const x2 = 5;
const res3 = x1 + x2; // <-- Конкатинация 
const output3 = document.querySelector(".out-16");

output3.innerHTML = `${x1} + ${x2} = ` + res3; 
...
console.log(divS3); // <-- выводится значение текущего значения divS3
...
// body.innerHTML = ""; // <-- Делает страницу пустой